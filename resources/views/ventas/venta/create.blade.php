		...
		<div class="form-group">
			...
			@foreach($personas as $persona)
				@if ($persona->nombre == "999999999 Consumidor Final")
					<option value="{{$persona->idpersona}}_{{$persona->tipo_cliente}}_{{$persona->porc_desc}}" selected>
						{{$persona->nombre}}
					</option>
				@else
					<option value="{{$persona->idpersona}}_{{$persona->tipo_cliente}}_{{$persona->porc_desc}}">
						{{$persona->nombre}}
					</option>
				@endif
			@endforeach
		...
		<div style="padding-top: 1px; padding-bottom: 1px;" class="panel-body">
			<div id="agregar_articulo">
				...
				<div>
					...
					<div class="col-lg-2 col-mg-2 col-sg-2 col-xs-12">
						<div class="form-group">
							<label for="precio_venta">Prec.Venta &nbsp;</label><input type="radio" name="prec" value="precio_normal" checked>N   &nbsp;<input type="radio" name="prec" value="precio_empresarial">E   &nbsp;<input type="radio" name="prec" value="precio_distribucion">D
